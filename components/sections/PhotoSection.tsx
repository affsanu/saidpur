...
const PhotoSection = (props: Props) => {
    return (
        <div className='bg-black w-full'>
            <div className='max-w-6xl h-[420px] grid grid-cols-1 md:grid-cols-5 gap-4 mx-auto py-6 px-3 md:px-4 lg:px-4 xl:px-0'>
                <div className='col-span-2 relative w-full h-full group cursor-pointer'>
                    <Image
