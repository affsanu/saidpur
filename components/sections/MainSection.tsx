...
import { Circle, Eye, Heart, MoveLeft, MoveRight, Pen } from "lucide-react";
        ...
        <Card className="max-w-6xl mx-auto md:h-[406px] lg:h-[338px]">
            <div className="grid grid-rows-2 md:grid-cols-2">
                ...
                <div className="relative md:order-0 cursor-pointer group">
                    <div className="flex flex-col">
                        <CardHeader className="md:space-y-6">
                            <div className="cursor-pointer">
                                <Badge className="uppercase gap-2 bg-rose-500 text-white">
                                    <Circle className="w-1 h-1 md:w-2 md:h-2" />
                                    বিনোদন
                                </Badge>
                            </div>
                            <div className="text-xl md:text-3xl lg:text-4xl font-semibold dark:text-slate-200 cursor-pointer group-hover:text-rose-500 duration-300">
                                স্বপ্নের মতো অভিষেক
                            </div>
                            <CardDescription className="flex text-xs gap-6">
                                <span className="flex items-center gap-1"><Pen className="w-3 h-3" />09 Sep, 2023</span>
                                <span className="flex items-center gap-1"><Eye className="w-3 h-3" />426</span>
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <p className="dark:text-slate-400">
                                ইনস্টাগ্রামে লি হান বিয়োলের অনুসারী হু হু করে বাড়ছে। অথচ সপ্তাহ তিনেক আগেও তাঁকে কেউ চিনতেন না। নেটফ্লিক্সের অরিজিনাল সিরিজ মাস্ক গার্ল-এ কেন্দ্রীয় চরিত্রে অভিনয় করে রাতারাতি তারকা বনে গেছেন তিনি।
                            </p>
                        </CardContent>
                        <CardFooter>
                    ...
                    <div className="absolute flex right-8 bottom-8 gap-4">
                        <MoveLeft className="h-5 w-5 cursor-pointer" />
                        <MoveRight className="h-5 w-5 cursor-pointer" />
                    </div>
                </div>
                {/*First Col Span*/}
                <div className="relative overflow-hidden rounded-t-md md:rounded-tl-none md:rounded-r-md md:order-1 h-full">
                    <div className="absolute inset-0">
