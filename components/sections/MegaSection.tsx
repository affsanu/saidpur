...
const items = [
    {
        title: "যুক্তরাষ্ট্রে বাংলাদেশের পোশাক রপ্তানি কমেছে",
    },
    {
                ...
                <div className='col-span-2 grid grid-cols-2 gap-4'>
                    {items.map((item, index) => (
                        <div key={index} className="relative group cursor-pointer">
                            <div className="absolute -inset-1 bg-gradient-to-r from-sky-600 to-rose-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
